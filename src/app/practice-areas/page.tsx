    ...
    <main className="py-16">
      ...
      >
        ...
        <p className="mt-4 max-w-2xl text-sm text-gray-200/90 leading-relaxed">
          ...
          matters involving intellectual property, restructuring, debt recovery,
          shareholder conflicts, class actions, and municipal finance. Our
      ...
      >
        ...
        <p className="mt-4 max-w-2xl text-sm text-gray-200/90 leading-relaxed">
          ...
          FDD disclosure requirements, franchise system conflicts, supply chain
          issues, and multi-plaintiff franchise matters. Our work spans
      ...
      >
        ...
        <p className="mt-4 max-w-2xl text-sm text-gray-200/90 leading-relaxed">
          ...
          litigation for corporations, partnerships, LLCs, and businesses of all
          sizes.
        </p>
      ...
      >
        ...
        <p className="mt-4 max-w-2xl text-sm text-gray-200/90 leading-relaxed">
          Our firm drafts and reviews Franchise Disclosure Documents, franchise
          agreements, and a full range of business contracts. We assist clients
          with franchise structuring, mergers and acquisitions, operational
          support, and business divestitures.
        </p>
      ...
      >
        ...
        <p className="mt-6 max-w-2xl text-sm text-gray-200/90 leading-relaxed">
          We handle civil disputes between individuals and businesses, including
          contract disagreements, fraud claims, products liability matters,
          consumer protection disputes, and professional liability issues. Our
          attorneys manage cases from early investigation through trial.
        </p>
